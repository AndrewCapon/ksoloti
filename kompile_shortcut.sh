...
case "$platform" in
    mac)
        ...
        ./platform_osx/bin/arm-none-eabi-objdump --source-comment --demangle --disassemble ./firmware/build/axoloti/normal/axoloti.elf > ./firmware/build/normal/axoloti.lst
        ./platform_osx/bin/arm-none-eabi-objdump --source-comment --demangle --disassemble ./firmware/build/axoloti/spilink/axoloti_spilink.elf > ./firmware/build/spilink/axoloti_spilink.lst
        ./platform_osx/bin/arm-none-eabi-objdump --source-comment --demangle --disassemble ./firmware/build/axoloti/usbaudio/axoloti_usbaudio.elf > ./firmware/build/usbaudio/axoloti_usbaudio.lst
        ...
        ./platform_osx/bin/arm-none-eabi-objdump --source-comment --demangle --disassemble ./firmware/build/ksoloti/normal/ksoloti.elf > ./firmware/build/normal/ksoloti.lst
        ./platform_osx/bin/arm-none-eabi-objdump --source-comment --demangle --disassemble ./firmware/build/ksoloti/spilink/ksoloti_spilink.elf > ./firmware/build/spilink/ksoloti_spilink.lst
        ./platform_osx/bin/arm-none-eabi-objdump --source-comment --demangle --disassemble ./firmware/build/ksoloti/usbaudio/ksoloti_usbaudio.elf > ./firmware/build/usbaudio/ksoloti_usbaudio.lst
        # sh ./qlean.sh
    ;;
    linux)
        rm -f ./firmware/build/*.*
